...
- current binary: build `2026050706`, with `arm64` explicitly present in the app, widget extension, and intents extension plists
- upload status: `2026050706` upload succeeded on 2026-05-07 and is validated in App Store Connect
- App Store Connect version page now has build `2026050706` selected for iOS version `1.0`; previously selected build `2026050705` and rejected build `2026050401` were removed from the selected build slot
- App Review notes were updated to address the May 7, 2026 `2.3.0` device-capability rejection and to name build `2026050706`
...
- accepted upload artifact: `output/app-store-builds/export-2026050706-arm64/Atlas.ipa`
...
- App Store Connect build metadata for `1.0 (2026050706)` on 2026-05-07: Binary State `Validated`, Bundle Version `2026050706`, Bundle ID `com.dkang2000.Atlas`, Minimum iOS `17.0`, Supported Architectures `arm64`, Device Family `iPhone`, Required Capabilities `arm64`, `get-task-allow=false`

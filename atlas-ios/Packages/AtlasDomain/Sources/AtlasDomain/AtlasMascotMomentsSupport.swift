...
public func atlasMascotInteractionResponse(
    ...
    case (.aetherion, .stage1):
        return AtlasMascotReactionSummary(
            ...
            detail: "Aetherion flares brighter when you check in.",
            symbolName: "bolt.fill"
        )
    case (.aetherion, .stage2):
        return AtlasMascotReactionSummary(
            title: "\(displayName) leans forward",
            detail: "Aetherion is ready to sprint into the next milestone.",
...
private func atlasMascotStageVoice(
    ...
    case (.aetherion, .stage1):
        return AtlasMascotStageVoice(
            shortcutLead: "Aetherion likes compact check-ins.",
            levelUpDetail: "Aetherion tightened its stance and started showing more contained power between milestones.",
            evolutionDetail: "Aetherion now carries enough stored charge to hint at Aetherion's faster silhouette.",
            badgeDetail: "Aetherion treats every badge like another shard of stormglass in the line.",
            goalDetail: "Aetherion read the closeout as proof that the line can keep its footing.",
            goalTail: "The little guardian is starting to trust the pattern.",
            streakDetail: "Aetherion is learning that repeated steps are how contained power becomes reliable force.",
            streakRescueDetail: "The line snapped back into place before the spark cooled.",
            nearEvolutionDetail: "Aetherion is starting to press through the edges of the current form.",
            archiveMilestoneDetail: "Even the earliest storm notes are starting to look collectible instead of incidental.",
            focusCarryForwardDetail: "Aetherion kept the target pinned instead of letting the week scatter.",
    ...
    case (.aetherion, .stage2):
        return AtlasMascotStageVoice(
            shortcutLead: "Aetherion answers quickly and wants the momentum kept moving.",
            levelUpDetail: "Aetherion sharpened the storm arc and locked in a faster posture for the next unlock.",
            evolutionDetail: "Aetherion looks disciplined now, like the line learned how to turn charge into direction.",
            badgeDetail: "Aetherion treats badges like field marks proving the line can stay kinetic under load.",
            goalDetail: "Aetherion reads the closeout as another clean push toward Aetherion.",
            goalTail: "The line feels more deliberate, not just more active.",
            streakDetail: "Aetherion thrives when the line keeps a diagonal, forward-moving rhythm.",
            ...
            focusCarryForwardDetail: "Aetherion kept the next objective locked in front instead of letting it drift.",
    ...
    case (.aurielle, .stage1):
        return AtlasMascotStageVoice(
            shortcutLead: "Aurielle likes gentle check-ins that do not add friction.",
            levelUpDetail: "Aurielle brightened and stood a little taller, like the first real rhythm finally arrived.",
            evolutionDetail: "Aurielle now feels ready to stretch into Aurielle's longer, more skybound motion.",
            badgeDetail: "Aurielle treats badges like tiny lights proving the line keeps finding its way back.",
            goalDetail: "Aurielle reads the closeout as reassurance that the week can stay soft and steady.",
            goalTail: "The little guardian is learning to trust repetition.",
            streakDetail: "Aurielle loves gentle repetition because it turns check-ins into familiarity instead of pressure.",
            streakRescueDetail: "The light came back before the week went dim.",
            nearEvolutionDetail: "Aurielle is beginning to show in the length and lift of the line.",
            archiveMilestoneDetail: "The gallery is starting to feel like a box of keepsakes instead of stray exports.",
            focusCarryForwardDetail: "Aurielle kept the weekly focus visible so the next week starts with less fog.",
    ...
    case (.aurielle, .stage2):
        return AtlasMascotStageVoice(
            shortcutLead: "Aurielle answers quietly, then keeps gliding.",
            levelUpDetail: "Aurielle widened the arc around the next unlock and settled into a more graceful, rising rhythm.",
            evolutionDetail: "Aurielle now looks fully skybound, like the line learned how to carry light without dropping it.",
            badgeDetail: "Aurielle treats badges like bright markers left along a clean flight path.",
            goalDetail: "Aurielle reads the closeout as another smooth step toward Aurielle.",
            goalTail: "The line looks calmer because it is more practiced.",
            streakDetail: "Aurielle makes streaks feel like glide paths instead of grind.",
            ...
            focusCarryForwardDetail: "Aurielle carried the focus into the next week without breaking the calm cadence.",
